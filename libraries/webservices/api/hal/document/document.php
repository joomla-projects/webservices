 ...
 * @since       1.2
 */
class JApiHalDocumentDocument extends JDocument
{
	/**
	 * Document name
	 *
	...
	/**
	 * @var    JApiHalHal  Main HAL object
	 * @since  1.2
	 */
	public $hal = null;
	...
	public function render($cache = false, $params = array())
	{
		...
		/* @var $hal JApiHalDocumentResource */
		$hal = $this->getBuffer();
	 ...
	 *
	 * @param   JApiHalHal  $hal  Hal object
	 *
	 * @return   JApiHalDocumentDocument
	 *
	 * @since  1.2
	 */
	 ...
	 *
	 * @param   JApiHalDocumentResource  $hal            Hal object which contains links (_links).
	 ...
	 *
	 * @return  JApiHalDocumentDocument instance of $this to allow chaining
	 *
	 * @since   1.2
	 */
