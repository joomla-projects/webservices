...
?>
<br />
<div class="fields-add-new-task-row">
	<div class="col-lg-4">
		<div class="input-group">
			<input type="text" class="form-control" name="newTask" onblur="this.value = this.value.replace(/[^\w]/g,'')"
			       placeholder="<?php echo JText::_('COM_WEBSERVICES_WEBSERVICE_TASK_ADD_NEW_TASK_PLACEHOLDER'); ?>" />
			<span class="input-group-btn">
				<button type="button" class="btn btn-default btn-success fields-add-new-task">
					<i class="icon-plus"></i>
					<?php echo JText::_('COM_WEBSERVICES_WEBSERVICE_TASK_ADD_NEW_TASK'); ?>
				</button>
			</span>
		</div>
	</div>
