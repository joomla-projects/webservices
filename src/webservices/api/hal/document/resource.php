 ...
 * @since  1.2
 */
class JApiHalDocumentResource extends JApiHalDocumentBase
{
	/**
	 * Json option
	 */
	 ...
	 * is set to true.
	 *
	 * @param   JApiHalDocumentLink  $link      Link
	 ...
	 */
	public function setLink(JApiHalDocumentLink $link, $singular = false, $plural = false)
	{
		$rel = $link->getRel();
	 ...
	 * @return JApiHalDocumentResource
	 */
	public function setReplacedLink(JApiHalDocumentLink $link, $group = '')
	{
		$rel = $link->getRel();
	 ...
	 * @param   JApiHalDocumentResource  $resource  Resource
	 * @param   bool                     $singular  Force overwrite of the existing embedded element
	 *
	 * @return JApiHalDocumentResource
	 */
	public function setEmbedded($rel, JApiHalDocumentResource $resource = null, $singular = false)
	{
		if ($singular)
		{
	 ...
	 *
	 * @param   JApiHalDocumentResource|null|array  $embedded  Embedded object
	 *
	 * @return array
	 */
	 ...
	 *
	 * @param   array|JApiHalDocumentLink  $links  Link object
	 *
	 * @return array
	 */
	...
	{
		/* @var $embed JApiHalDocumentResource */
		foreach ($embedded as $rel => $embed)
		{
			if ($embed instanceof JApiHalDocumentResource)
			{
	 ...
	 *
	 * @param   JApiHalDocumentResource  $embed  Embedded object
	 *
	 * @return SimpleXMLElement
	 */
	protected function _getEmbRes(JApiHalDocumentResource $embed)
	{
	 ...
	 * @return void
	 */
	protected function _addLinks(JApiHalDocumentLink $link)
	{
	 ...
	 * @return JApiHalDocumentResource
	 */
	protected function _addLink(JApiHalDocumentLink $link)
	{
