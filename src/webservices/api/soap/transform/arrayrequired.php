 ...
 * @since       1.4
 */
final class JApiSoapTransformArrayrequired extends JApiSoapTransformBase
{
	/**
	 * string type
	 *
	...
	public function wsdlField($field, &$sequence, &$typeSchema, $elementName, $validateOptional = false, $extraFields = array())
	{
		...
		{
			JApiSoapHelper::addElementFields($extraFields, $typeSchema, $elementName . '_' . $field['name']);
		}
	}
}
