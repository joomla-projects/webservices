 ...
 * @since       1.4
 */
class JApiSoapDocumentDocument extends JDocument
{
	/**
	 * Document name
	 *
	 ...
	 *
	 * @param   JApiSoapSoap  $soap  Soap object
	 *
	 * @return   JApiSoapDocumentDocument
	 *
	 * @since  1.4
	 */
	 ...
	 *
	 * @return  JApiSoapDocumentDocument instance of $this to allow chaining
	 *
	 * @since   1.4
	 */
